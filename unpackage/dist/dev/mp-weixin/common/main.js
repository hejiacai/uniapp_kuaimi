...
var _index = __webpack_require__(/*! @/static/commonjs/request/index.js */ 16);



var _eventList = _interopRequireDefault(__webpack_require__(/*! @/static/commonjs/eventList/eventList.js */ 22));
...
var _KM = _interopRequireDefault(__webpack_require__(/*! @/static/commonjs/KM/KM.js */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}_vue.default.prototype.$GlobalV = _eventList.default;_vue.default.prototype.$http = _index.http;_vue.default.config.productionTip = false;_vue.default.prototype.$store = _store.default;
_vue.default.prototype.$KM = _KM.default;
_App.default.mpType = 'app';

_vue.default.prototype.$scrollOffset = function () {
  return new Promise(function (resolve, reject) {
    uni.createSelectorQuery().selectViewport().scrollOffset(function (res) {return res ? resolve(res) : reject('获取滚动距离失败');}
    // console.log("竖直滚动位置" + res.scrollTop);
    ).exec();
  });
};
_vue.default.prototype.$location = function (selector) {var _this = this; // 获取元素宽高位置信息
  return new Promise(function (resolve, reject) {
    uni.createSelectorQuery().in(_this).select(selector).boundingClientRect(function (data) {return data ? resolve(data) : reject(
      '元素不存在');}).exec();
  });
};
...
/* hot reload */
if (false) { var api; }
component.options.__file = "E:/uni_mblue/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 10 */
/*!*****************************************************!*\
  !*** E:/uni_mblue/App.vue?vue&type=script&lang=js& ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  onLaunch: function onLaunch() {
    ...
    // this.$KM.setStorage('token',"");
  },
  onShow: function onShow() {
    var getToken = this.$KM.getStorage('token');
...
/* 13 */
/*!*************************************************************!*\
  !*** E:/uni_mblue/App.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
